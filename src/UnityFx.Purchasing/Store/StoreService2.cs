...
{
	/// <summary>
	/// Implementation of <see cref="IStoreService2"/>.
	/// </summary>
	internal sealed partial class StoreService2 : IStoreService2, IStoreProductCollection2, IObservable<PurchaseInfo>
	{
		#region data
		...
		internal StoreService2(string name, IPurchasingModule purchasingModule, IStoreDelegate storeDelegate)
		{
		...
		public IStoreProductCollection2 Products => this;
